...
using MysticFramework.ClientLib.Nodes;
using MysticFramework.Shared.Packets;

namespace MysticFramework.ClientLib.Features;
...
public abstract partial class SyncedCharacterController : ClientNetworkNode
{
	...
	{
		Client.RegisterNestedType<UserInput>();
	...
	private void SendInputs(int currentTick)
	{
		...
		Client.Send(packet, DeliveryMethod.Unreliable);
	}
